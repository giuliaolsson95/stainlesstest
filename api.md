...
- <code title="put /account-management/accounts/{id}">client.accounts.<a href="./src/resources/accounts.ts">update</a>(id1, { ...params }) -> Account</code>
...
- <code title="put /org/firms/{id}">client.org.firms.<a href="./src/resources/org/firms.ts">update</a>(id1, { ...params }) -> FirmUpdateResponse</code>
...
- <code title="put /billing/groups/{id}">client.billingGroups.<a href="./src/resources/billing-groups.ts">update</a>(id1, { ...params }) -> BillingGroupUpdateResponse</code>
...
- <code title="put /billing/asset-adjustments/{id}">client.billing.assetAdjustments.<a href="./src/resources/billing/asset-adjustments.ts">update</a>(id1, { ...params }) -> AssetAdjustmentUpdateResponse</code>
...
- <code title="put /billing/minimums/{id}">client.billing.minimums.<a href="./src/resources/billing/minimums.ts">update</a>(id1, { ...params }) -> MinimumUpdateResponse</code>
...
- <code title="put /billing/fee-structures/{id}">client.billingFeeStructures.<a href="./src/resources/billing-fee-structures.ts">update</a>(id1, { ...params }) -> BillingFeeStructureUpdateResponse</code>
...
- <code title="put /billing/splits/{id}">client.billingSplits.<a href="./src/resources/billing-splits.ts">update</a>(id1, { ...params }) -> BillingSplitUpdateResponse</code>
...
- <code title="put /reporting/households/{id}">client.reporting.households.<a href="./src/resources/reporting/households.ts">update</a>(id1, { ...params }) -> HouseholdUpdateResponse</code>
...
- <code title="put /reporting/target-allocations/{id}">client.reporting.targetAllocations.<a href="./src/resources/reporting/target-allocations.ts">update</a>(id1, { ...params }) -> TargetAllocationUpdateResponse</code>
...
- <code title="put /reporting/asset-classifications/{id}">client.assetClassifications.<a href="./src/resources/asset-classifications.ts">updateSingle</a>(id1, { ...params }) -> AssetClassificationUpdateSingleResponse</code>
...
- <code title="put /reporting/class-tags/{id}">client.classificationTags.<a href="./src/resources/classification-tags.ts">update</a>(id1, { ...params }) -> ClassificationTagUpdateResponse</code>
...
- <code title="put /reporting/benchmarks/{id}">client.benchmarks.<a href="./src/resources/benchmarks.ts">update</a>(id1, { ...params }) -> BenchmarkUpdateResponse</code>
...
- <code title="put /investment-management/models/{id}">client.investmentManagement.models.<a href="./src/resources/investment-management/models.ts">update</a>(id1, { ...params }) -> ModelUpdateResponse</code>
...
- <code title="put /investment-management/strategies/{id}">client.investmentManagement.strategies.<a href="./src/resources/investment-management/strategies.ts">update</a>(id1, { ...params }) -> StrategyUpdateResponse</code>
