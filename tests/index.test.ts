...
import { APIUserAbortError } from 'bridgefttest';
import { Headers } from 'bridgefttest/core';
...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['BRIDGEFTTEST_BASE_URL'] = undefined;
    });
    ...
    test('env variable', () => {
      process.env['BRIDGEFTTEST_BASE_URL'] = 'https://example.com/from_env';
      const client = new Bridgefttest({
        bearerToken: 'My Bearer Token',
        username: 'My Username',
        password: 'My Password',
    ...
    test('empty env variable', () => {
      process.env['BRIDGEFTTEST_BASE_URL'] = ''; // empty
      const client = new Bridgefttest({
        bearerToken: 'My Bearer Token',
        username: 'My Username',
        password: 'My Password',
      });
      expect(client.baseURL).toEqual('https://api.bridgeft.com/v2');
    });

    test('blank env variable', () => {
      process.env['BRIDGEFTTEST_BASE_URL'] = '  '; // blank
      const client = new Bridgefttest({
        bearerToken: 'My Bearer Token',
        username: 'My Username',
        password: 'My Password',
  ...
  test('maxRetries option is correctly set', () => {
    ...
    // default
    const client2 = new Bridgefttest({
      bearerToken: 'My Bearer Token',
      username: 'My Username',
      password: 'My Password',
    });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['BASIC_AUTH_USERNAME'] = 'My Username';
    process.env['BASIC_AUTH_PASSWORD'] = 'My Password';
    const client = new Bridgefttest();
  ...
  test('with overridden environment variable arguments', () => {
    ...
    process.env['BASIC_AUTH_PASSWORD'] = 'another My Password';
    const client = new Bridgefttest({
      bearerToken: 'My Bearer Token',
      username: 'My Username',
      password: 'My Password',
