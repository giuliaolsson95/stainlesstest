...
describe('resource advisorCodes', () => {
  test('createMany: only required params', async () => {
    const responsePromise = client.advisorCodes.createMany([{}]);
  ...
  test('createMany: required and optional params', async () => {
    const response = await client.advisorCodes.createMany([{}]);
  });

  test('deleteMany', async () => {
    const responsePromise = client.advisorCodes.deleteMany({});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
